...
//                            해당 클래스가 추상 클래스이거나 인터페이스일 경우(InstantiationException),
//                            또는 클래스나 생성자가 접근 제한자로 인해 접근할 수 없을 경우(IllegalAccessException)
//                            예외 발생한다.
...
public class NewInstanceEx3 {
    public static void main(String[] args) {
        try {
            // 런타임 시 결정되는 클래스 이름
//            Class clazz = Class.forName("_11_basicAPIClass._6_class.SendAction");
            Class clazz = Class.forName("_11_basicAPIClass._6_class.ReceiveAction");
